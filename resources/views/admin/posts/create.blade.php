            ...
            <div class="p-6 mt-10 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ route('admin.posts.store')}}" method="post">
                    ...
                    <div class="w-full mb-6">
                        ...
                        <input type="text" name="title" id="title" class="w-full rounded" autofocus>
                    </div>
                    <div class="w-full mb-6">
                        <label for="description" class="block text-white"> Description</label>
                        <input type="text" name="description" id="description" class="w-full rounded">
                    </div>

                    <div class="w-full mb-6">
                        <label for="content" class="block text-white"> Conteudo</label>
                        <textarea name="body" id="content" cols="40" rows="5" class="w-full rounded"></textarea>
                    </div>
